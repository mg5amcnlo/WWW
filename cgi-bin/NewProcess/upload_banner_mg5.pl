...
if ( -e "$directory/proc_card_mg5.dat"){
    open(CARD,"<$directory/proc_card_mg5.dat") or
	WriteError("The resulting proc_card_mg5 could not be opened.");
} else {
...
print "<HTML>\n<HEAD> \n";
print "<TITLE>Banner upload failed</TITLE></HEAD>\n<BODY>\n";
print "<H2>Banner upload failed</H2>\n";
print "$errormsg";
